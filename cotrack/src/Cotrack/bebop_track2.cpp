...
{   ros::init(argc, argv, "bebop_test2");
    ...
    char iden_path[256];
    sprintf(iden_path, "/home/jacky/cotrack_ws/data/cotrack-%d-%02d-%02d_%02d-%02d.txt", time->tm_year+1900, time->tm_mon+1, time->tm_mday, time->tm_hour, time->tm_min);
    ...
    else
    {
        ...
        out_data_file <<" Time "<< " bebop1_x " << " bebop1_y " << " bebop1_vx "<< " bebop1_vy "<< " bebop1_yaw "\
                                << " bebop2_x " << " bebop2_y " << " bebop2_vx "<< " bebop2_vy "<< " bebop2_yaw "\
                                << " bebop3_x " << " bebop3_y " << " bebop3_vx "<< " bebop3_vy "<< " bebop3_yaw "\
                                << " bebop4_x " << " bebop4_y " << " bebop4_vx "<< " bebop4_vy "<< " bebop4_yaw "\
...
//        u_cooper[1]=0;
        ...
        else
        {
          ...
          h_x_4=r*cos(w*t-dtheta);
          h_y_4=r*sin(w*t-dtheta);
          dot_h_x_4=-r*w*sin(w*t-dtheta);
          dot_h_y_4=r*w*cos(w*t-dtheta);
          dot2_h_x_4=-r*w*w*cos(w*t-dtheta);
          dot2_h_y_4=-r*w*w*sin(w*t-dtheta);
        ...
        if(abs(bp2_state.pos_x)>3||abs(bp2_state.pos_y)>3)
